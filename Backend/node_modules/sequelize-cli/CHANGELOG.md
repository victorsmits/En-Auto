...
## v2.2.1 - 2015-11-24
### Fixed
- Filtering of js files in models/connection.js
...
## v1.8.0 - 2015-08-27
### Added
- Support for env variable usage in model/connection.js
...
## 0.2.6
### Changed
- Do not load lodash in `models/connection.js`.
...
## 0.1.0
### Changed
- `sequelize init` now creates a `models` folder and a `models/connection.js` file. [#11](https://github.com/sequelize/cli/pull/11)
