...
test('$NODE_PATH', function (t) {
    ...
    resolve('aaa', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/x/aaa/connection.js'), 'aaa resolves');
    });
    ...
    resolve('bbb', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/y/bbb/connection.js'), 'bbb resolves');
    });
    ...
    resolve('ccc', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/x/ccc/connection.js'), 'ccc resolves');
    });
